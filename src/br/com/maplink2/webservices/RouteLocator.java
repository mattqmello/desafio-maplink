...
public class RouteLocator extends org.apache.axis.client.Service implements br.com.maplink2.webservices.Route {
    ...
    private java.lang.String RouteSoap_address = "http://services.maplink.com.br/webservices/v3/route/route.asmx";
    ...
    public br.com.maplink2.webservices.RouteSoap getRouteSoap(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            br.com.maplink2.webservices.RouteSoapStub _stub = new br.com.maplink2.webservices.RouteSoapStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (br.com.maplink2.webservices.RouteSoap.class.isAssignableFrom(serviceEndpointInterface)) {
                br.com.maplink2.webservices.RouteSoapStub _stub = new br.com.maplink2.webservices.RouteSoapStub(new java.net.URL(RouteSoap_address), this);
                _stub.setPortName(getRouteSoapWSDDServiceName());
                return _stub;
            }
        }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("http://webservices.maplink2.com.br", "Route");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("http://webservices.maplink2.com.br", "RouteSoap"));
        }
