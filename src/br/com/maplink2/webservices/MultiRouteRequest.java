...
public class MultiRouteRequest  implements java.io.Serializable {
    ...
    private br.com.maplink2.webservices.RouteStop destination;
    ...
    public MultiRouteRequest(
           ...
           br.com.maplink2.webservices.RouteStop destination) {
           this.origin = origin;
     ...
     * @return destination
     */
    public br.com.maplink2.webservices.RouteStop getDestination() {
        return destination;
    }
     ...
     * @param destination
     */
    public void setDestination(br.com.maplink2.webservices.RouteStop destination) {
        this.destination = destination;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://webservices.maplink2.com.br", "MultiRouteRequest"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("http://webservices.maplink2.com.br", "destination"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://webservices.maplink2.com.br", "RouteStop"));
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
    }
